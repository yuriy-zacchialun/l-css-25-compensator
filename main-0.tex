...
\author{Yuriy \textbf{Zacchia Lun}\,\textsuperscript{\orcidlink{0000-0002-9408-8773}}, Fortunato \textbf{Santucci}\,\textsuperscript{\orcidlink{0000-0002-0229-6277}}, and Alessandro \textbf{D'Innocenzo}\,\textsuperscript{\orcidlink{0000-0002-5239-0894}}% <-this % stops a space
\thanks{*This work was supported in part by the Italian Government under PON Ricerca \& Innovazione 2014-2020 (AIM
1877124 - Attivit\`{a} 1) and CIPE resolution n. 70/2017 (Centre %of Excellence on Connected, Geo-Localized and Cybersecure Vehicles 
EX-Emerge).}% <-this % stops a space
...
\end{bmatrix}^{\top}$}.
\end{equation*}
The FSMC thresholds $\{\beta_i\}_{i=1}^{3}$ \text{\small $ = \{-3.21,-2.55,-1.80\}$} dB.
...
\caption{\text{\small $\rho(\mathit{\Lambda})$} from \eqref{eq:Lambda} as a function of %the number of future control inputs 
...
\caption{The long-run average cost $J_{\infty}^{\star}$ from \eqref{eq:lmi-cost} as a function of % the number of future control inputs 
$n_f$.}\label{fig:cost}
\vspace{-2mm}
\end{center}
\end{figure}

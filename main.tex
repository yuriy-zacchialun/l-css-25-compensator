...
We consider a discrete-time linear system % in the standard state-space form
...
% \subsection{Wireless SF Control with imperfect CSI}\label{subsec:wireless-control}
